			...
			.then(allTweet=>allTweet.json())
				.then((allTweetsFromFetch) =>{
					const tweetsToDisplay= allTweetsFromFetch.allTweets.map((obj)=>{
						return <Tweet firstname ={obj.firstname} username ={obj.firstname}
						 content = {obj.tweetContent} hashtags = {obj.hashtags} likes={obj.likes}
						 id={obj._id} date={obj.date}/>
					})
		...
		<div className={styles.main}>
			...
			<div className={styles.middle}>
				<div className={styles.middle2}>
					...
					<button className={styles.button2} onClick={()=>{getAllTweet()}}>Tweet</button>
				</div>
				{allTweets}
			</div>
